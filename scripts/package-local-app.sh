...
/usr/bin/plutil -insert CFBundleIdentifier -string com.didi.codex-account-switcher.local "$CONTENTS_DIR/Info.plist"
...
/usr/bin/plutil -insert NSSupportsAutomaticTermination -bool false "$CONTENTS_DIR/Info.plist"
